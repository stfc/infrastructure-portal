 ...
 * @MapLink(
 *   id = "waze_navigate",
 *   name = @Translation("Waze - Navigate (immediately starts navigating to address)")
 * )
 */
class WazeNavigate extends MapLinkBase {
  ...
  public function getAddressUrl(AddressInterface $address) {
    return Url::fromUri('https://waze.com/ul', ['query' => ['q' => $this->addressString($address), 'navigate' => 'yes']]);
  }
