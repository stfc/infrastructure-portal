  ...
  protected function getAvailableEntitySources() {
    $options = [
      '__base_table' => new TranslatableMarkup('View Base Entity (@entity_type)', [
        '@entity_type' => isset($this->entityInfo) && $this->entityInfo instanceof EntityTypeInterface ? $this->entityInfo->getLabel() : $this->entityType,
      ]),
    ];
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if (count($entity_sources) == 1) {
      ...
      $form['entity_source'] = [
        ...
        '#description' => new TranslatableMarkup('Select which Entity should be used as Geofield Mapping base Entity. <b>Note:</b> This would affect Map Theming logics and options.'),
